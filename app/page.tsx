  ...
  return (
    <>
      <main className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div
          id="introduction"
          className="p-6 rounded-lg gap-2 flex flex-col justify-between "
        >
          <h2 className="text-4xl font-bold mb-4">Introducing Aihub.sh</h2>
          {/* <div className="w-full h-48 bg-black rounded-full" /> */}

          <div className="w-full flex justify-center">
            <video
              className="w-full max-w-[340px] object-cover rounded-full z-10"
              autoPlay
              loop
              muted
            >
              <source src="/videos/introduction.webm" type="video/mp4" />
            </video>
          </div>
          <div className="flex items-center space-x-2 mt-4">
            <MegaphoneIcon className="w-4 h-4" />
            <span className="text-sm">Whisper</span>
            <span className="text-sm text-white">— Speech Recognition</span>
          </div>
        </div>
